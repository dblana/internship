...
In this markdown, we will present some ideas to propose forecasting time series data in R.
...
Here, to illustrate our results, we will focus on data concerning the state of Colorado. For this reason, we will create another variable  `data_co` containing the data that interests us.
```{r cars}
